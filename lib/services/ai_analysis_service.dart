...
要求：
1. 按推荐买入的优先级排序，最值得买入的排第一
2. 每只推荐的股票给出一句话理由，不超过 30 字
3. 只推荐有明确买入信号或值得关注的股票，没有就不推荐

请以 JSON 格式返回（rank 为推荐排名，1 为最优先）：
[
  {"rank": 1, "code": "600519", "name": "贵州茅台", "reason": "周线放量突破平台，日线回踩20日均线"},
  {"rank": 2, "code": "000001", "name": "平安银行", "reason": "底部放量反转，MACD金叉"},
  ...
]
